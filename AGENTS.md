...
This project is indexed by GitNexus as **IntelliStock** (42459 symbols, 80156 relationships, 144 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
