...
This project is indexed by GitNexus as **IntelliStock** (18600 symbols, 37175 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
