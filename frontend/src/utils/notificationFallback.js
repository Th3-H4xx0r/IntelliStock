...
export const FALLBACK_TYPES = [
  ...
  { key: 'swing_exit', group: 'Swing & Wheel', label: 'Swing exit', desc: 'The swing lane sold a position' },
  ...
  { key: 'swing_approval_failed', group: 'Swing & Wheel', label: 'Approved order refused', desc: 'A swing or wheel order you approved could not be sent' },
]
